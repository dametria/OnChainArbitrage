...
export const bscConfig = {
  ...
  monitoring: {
    ...
    watchedPairs: [
      ...
      { name: "WBNB/WETH", token0: "WBNB", token1: "WETH", enabled: false },
      { name: "WBNB/BTCB", token0: "WBNB", token1: "BTCB", enabled: false },
      ...
      { name: "CAKE/WBNB", token0: "CAKE", token1: "WBNB", enabled: false },
      { name: "CAKE/USDT", token0: "CAKE", token1: "USDT", enabled: false },
      { name: "BANANA/WBNB", token0: "BANANA", token1: "WBNB", enabled: false },
      { name: "UNI/WBNB", token0: "UNI", token1: "WBNB", enabled: false },
      { name: "LINK/WBNB", token0: "LINK", token1: "WBNB", enabled: false },
      { name: "AAVE/WBNB", token0: "AAVE", token1: "WBNB", enabled: false },
      { name: "AXS/WBNB", token0: "AXS", token1: "WBNB", enabled: false },
      { name: "GALA/WBNB", token0: "GALA", token1: "WBNB", enabled: false },
      { name: "ADA/WBNB", token0: "ADA", token1: "WBNB", enabled: false },
      { name: "DOT/WBNB", token0: "DOT", token1: "WBNB", enabled: false },
      { name: "MATIC/WBNB", token0: "MATIC", token1: "WBNB", enabled: false },
    ],
  },
};
